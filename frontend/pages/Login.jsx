...
import axios from 'axios';  //Axios is a popular JavaScript library used in React for making HTTP requests to external APIs.
...
const Login = () => {
  ...
  const onSubmitHandler = async (e) => {
    try {
      ...
      axios.defaults.withCredentials = true  // to send the cookies also, along with the request 
